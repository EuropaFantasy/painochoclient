...
// - We never use any of the helpers/facilities used internally by Dear ImGui, unless available in the base API.
...
static void ShowDemoWindowWidgets() {
    ...
    if (ImGui::TreeNode("Data Types")) {
        ...
        // To avoid polluting the base API with all possible combinations, we use the ImGuiDataType enum
...
static void ShowDemoWindowInputs() {
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus")) {
        ...
        if (ImGui::TreeNode("Inputs")) {
            ...
            } // FIXME: We should convert 'c' to UTF-8 here but the functions are not base.
...
// Forward declare ShowFontAtlas() which isn't worth putting in base API yet
