...
// Enumerations
// - We don't use strongly typed enums much because they add constraints (can't extend in internals code, can't store typed in bit fields, extra casting on iteration)
...
namespace ImGui {
    ...
    IMGUI_API bool InvisibleButton(const char *str_id, const ImVec2 &size,
                                   ImGuiButtonFlags flags = 0); // flexible button behavior without the visuals, frequently useful to build custom behaviors using the base api (along with IsItemActive, IsItemHovered, etc.)
...
//-----------------------------------------------------------------------------
// - You generally do NOT need to care or use this ever. But we need to make it available in imgui.h because some of our base structures are relying on it.
...
struct ImGuiIO {
    ...
    // (default to use native Win32 clipboard on Windows, otherwise uses a internals clipboard. Override to access OS clipboard on other architectures)
