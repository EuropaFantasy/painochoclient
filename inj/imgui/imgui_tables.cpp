...
//-----------------------------------------------------------------------------
// Typical tables call flow: (root level is generally base API):
//-----------------------------------------------------------------------------
...
// This difference with is the reason why this is not base yet.
...
// FIXME-TABLE: TableOpenContextMenu() and TableGetHeaderRowHeight() are not base.
...
void ImGui::DebugNodeTable(ImGuiTable *table) {
    const bool is_active = (table->LastFrameActive >= GetFrameCount() -
